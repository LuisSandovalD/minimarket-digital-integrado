      ...
      html: `
                <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: auto; border: 1px solid #cbd5e1; border-radius: 8px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        ...
                        <p style="color: #64748b; font-size: 14px;">Inicios de sesión protegidos - Minimarket Digital Integrado</p>
                    </div>
                    ...
                    <small style="color: #94a3b8;">Seguridad de Accesos • Minimarket Digital Integrado</small>
                </div>
            `,
    }).catch(emailError => {
    ...
    sendEmail({
      ...
      html: `
                <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: auto; border: 1px solid #cbd5e1; border-radius: 8px;">
                    ...
                    <p>Te informamos que se acaba de registrar un acceso exitoso a tu cuenta en la plataforma **Minimarket Digital Integrado**.</p>
