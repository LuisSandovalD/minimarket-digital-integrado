// ============================================================================
// prisma/seeds/sale.seed.2025.js
// Ventas distribuidas exclusivamente en el año 2025 - CORREGIDO MULTI-TENANT
// ============================================================================
...
async function saleJsonPayloadSeed2025() {
    ...
    const basePayload = [
        { notes: "Venta minorista de la semana", details: [{ productId: 1, quantity: 6, salePrice: 7.50 }, { productId: 2, quantity: 4, salePrice: 14.00 }] },
        { notes: "Venta por mostrador a cliente final", details: [{ productId: 4, quantity: 10, salePrice: 4.50 }, { productId: 5, quantity: 12, salePrice: 5.00 }] },
        { notes: "Pedido de insumos básicos e inventario", details: [{ productId: 7, quantity: 15, salePrice: 3.50 }, { productId: 8, quantity: 20, salePrice: 3.80 }] },
        { notes: "Atención corporativa express de insumos", details: [{ productId: 10, quantity: 7, salePrice: 6.90 }] },
        { notes: "Venta de fin de semana - Pack Promocional", details: [{ productId: 1, quantity: 20, salePrice: 7.20 }, { productId: 13, quantity: 18, salePrice: 6.50 }] },
        { notes: "Despacho regular a cliente recurrente", details: [{ productId: 15, quantity: 12, salePrice: 12.50 }] },
        { notes: "Cierre de turno tarde - Rotación rápida", details: [{ productId: 18, quantity: 25, salePrice: 2.20 }] },
        { notes: "Venta mayorista pequeña por volumen", details: [{ productId: 4, quantity: 24, salePrice: 4.10 }] },
        { notes: "Artículos de cuidado especializado", details: [{ productId: 19, quantity: 5, salePrice: 29.90 }] },
        { notes: "Venta góndola de artículos variados", details: [{ productId: 3, quantity: 15, salePrice: 1.80 }] },
        { notes: "Consumo institucional express", details: [{ productId: 6, quantity: 12, salePrice: 6.50 }, { productId: 11, quantity: 10, salePrice: 5.50 }] },
        { notes: "Reposición rápida de almacén diario", details: [{ productId: 10, quantity: 6, salePrice: 6.90 }] },
        { notes: "Venta directa de mostrador", details: [{ productId: 2, quantity: 8, salePrice: 14.00 }] },
        { notes: "Venta estratégica para aliado local", details: [{ productId: 9, quantity: 3, salePrice: 110.00 }] },
        { notes: "Último despacho comercial del mes", details: [{ productId: 11, quantity: 12, salePrice: 5.50 }] },
        { notes: "Compra matutina express", details: [{ productId: 5, quantity: 6, salePrice: 4.90 }, { productId: 18, quantity: 8, salePrice: 2.50 }] },
        { notes: "Pack operativo para negocio local", details: [{ productId: 11, quantity: 12, salePrice: 4.50 }, { productId: 12, quantity: 12, salePrice: 3.20 }] },
        { notes: "Abastecimiento regular para menú del día", details: [{ productId: 7, quantity: 20, salePrice: 3.10 }, { productId: 9, quantity: 10, salePrice: 2.70 }] },
        { notes: "Venta de mostrador - Reposición bodega", details: [{ productId: 19, quantity: 10, salePrice: 11.50 }, { productId: 20, quantity: 15, salePrice: 1.50 }] },
        { notes: "Cliente se lleva lote pequeño de stock", details: [{ productId: 1, quantity: 10, salePrice: 7.20 }] },
        { notes: "Venta regular - Útiles de aseo y cuidado", details: [{ productId: 12, quantity: 10, salePrice: 9.80 }, { productId: 16, quantity: 8, salePrice: 6.20 }] },
        { notes: "Pedido para evento institucional", details: [{ productId: 13, quantity: 25, salePrice: 6.50 }, { productId: 14, quantity: 20, salePrice: 2.50 }] },
        { notes: "Compra express para el almuerzo corporativo", details: [{ productId: 16, quantity: 10, salePrice: 7.90 }, { productId: 17, quantity: 6, salePrice: 16.50 }] },
        { notes: "Venta de oficina - Reposición de archivadores", details: [{ productId: 12, quantity: 20, salePrice: 1.80 }, { productId: 13, quantity: 4, salePrice: 22.00 }] },
        { notes: "Venta de contingencia por temporada", details: [{ productId: 8, quantity: 12, salePrice: 9.50 }] },
        { notes: "Venta rápida de tarros de stock", details: [{ productId: 4, quantity: 30, salePrice: 4.20 }] },
        { notes: "Insumos para producción comercial", details: [{ productId: 10, quantity: 3, salePrice: 98.00 }] },
        { notes: "Pack familiar de artículos varios", details: [{ productId: 13, quantity: 25, salePrice: 1.80 }, { productId: 14, quantity: 12, salePrice: 3.90 }] },
        { notes: "Venta mostrador - Servilletas institucionales", details: [{ productId: 17, quantity: 25, salePrice: 2.10 }] },
        { notes: "Abastecimiento express regular", details: [{ productId: 2, quantity: 12, salePrice: 13.80 }] },
    ];

    // Incrementamos las repeticiones a 7 en 2025 para simular mayor tracción comercial
    const totalRepetitions = 7;
        ...
        for (let rep = 0; rep < totalRepetitions; rep++) {
            for (const baseItem of basePayload) {
                ...
                await prisma.$transaction(async (tx) => {
                    ...
                    const esCredito = Math.random() < 0.25; // 2025: Mayoritariamente operaciones al contado (75%)
                    const status = esCredito ? "PENDING" : "COMPLETED";
                    const porcentaje = esCredito ? (0.30 + Math.random() * 0.20) : 1.0;
...
if (require.main === module) {
    saleJsonPayloadSeed2025()
        .catch((e) => {
            console.error("❌ Error detectado en el proceso de seed de ventas [2025]:", e);
            process.exit(1);
        })
        .finally(async () => {
...
module.exports = { saleJsonPayloadSeed2025 };