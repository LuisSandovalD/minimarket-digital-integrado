    ...
    <>
      <header
        className="
          ...
          border-b border-[#d7e0e7]/40
          bg-white/60 shadow-[0_8px_30px_rgba(15,23,42,0.08)]
          backdrop-blur-2xl supports-[backdrop-filter]:bg-white/45
          transition-all duration-300
          dark:border-[#365d86]/20 dark:bg-[#0b1120]/55
      ...
      >
        ...
        <div
          className="
            ...
            bg-gradient-to-r from-[#eef4f8]/20 via-transparent to-[#a3cef1]/20
            dark:from-[#274c77]/20 dark:via-[#13263b]/20 dark:to-[#6096ba]/20
          "
        />
        ...
        <div
          className="
            ...
            from-transparent via-[#6096ba]/50 to-transparent
            dark:via-[#a3cef1]/35
          "
        />
