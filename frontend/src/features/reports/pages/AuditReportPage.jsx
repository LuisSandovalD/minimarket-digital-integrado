// ========================================
// features/analytics/pages/AuditReportPage.jsx
// ========================================

import { SkeletonTable } from "@/components/skeletons";
import { AlertTriangle, Calendar, RefreshCw, ShieldCheck } from "lucide-react";
...
export default function AuditReportPage({ filters }) {
  ...
  const fetchPdf = async () => {
    ...
    try {
      ...
      console.error(err);
      setError(err.message || "Error al generar el reporte de auditoría.");
    } finally {
      setLoading(false);
    }
  };
