// ========================================
// features/analytics/pages/PaymentsReportPage.jsx
// ========================================
...
export default function PaymentsReportPage({ filters }) {
  ...
  const fetchPdf = async () => {
    ...
    try {
      ...
      console.error(err);
      setError(err.message || "Error al generar el reporte de pagos.");
    } finally {
      setLoading(false);
    }
  };
