    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-slate-50 p-4 border border-slate-100 dark:bg-white/[0.02] dark:border-white/5">
        <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
          💡 <strong>Nota:</strong> Tu plan incluye la gestión de una sucursal base de manera gratuita. Si dejas estos
          campos vacíos, el sistema la configurará automáticamente como tu <strong>"Casa Matriz"</strong> usando los
          datos de la empresa.
        </p>
      </div>
