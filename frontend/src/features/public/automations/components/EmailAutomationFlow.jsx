...
import { EMAIL_FLOW } from "../constants/automationsData.js";
import FlowGrid from "./FlowGrid.jsx";

// Variantes de animación idénticas a tu diseño
const fastStagger = {
  hidden: { opacity: 0 },
  show: {
    opacity: 1,
...
export default function EmailAutomationFlow() {
  const Icon = EMAIL_FLOW.icon;
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        >
          {EMAIL_FLOW.description}
        </motion.p>
      </motion.div>

      {/* Grid de Tarjetas por Columnas */}
      <FlowGrid flows={[EMAIL_FLOW]} columns={2} animate={true} />
    </div>
  );
}
