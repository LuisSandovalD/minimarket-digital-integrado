  ...
  return (
    <section className="relative py-20 max-w-7xl mx-auto px-6">
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
        ...
        {/* RIGHT INFO */}
        <div className="rounded-2xl border border-[#d7e0e7] bg-white/10 px-5 py-4 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.03] lg:max-w-xs">
