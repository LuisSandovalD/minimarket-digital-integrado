...
import { PURCHASE_FEATURES } from "../constants/featuresData.js";
    ...
    <section className="relative overflow-hidden bg-dark text-dark-foreground px-4 py-24 sm:px-6 md:px-8 lg:px-10 z-10">
      ...
      <div className="mx-auto  w-full flex flex-col items-center">
        ...
        >
          ...
          >
            Sincroniza tus almacenes, controla los flujos de abastecimiento de
            tus proveedores y automatiza procesos con analítica predictiva.
          </motion.p>
        </motion.div>

        {/* ================= REJILLA SIMÉTRICA UTILIZANDO METRICCARD ================= */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full relative z-20">
          {PURCHASE_FEATURES.map((group, groupIdx) => (
            <motion.div
