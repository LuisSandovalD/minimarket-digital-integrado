    ...
    <section className="relative mx-auto max-w-7xl overflow-hidden px-6 py-16">
      ...
      >
        ...
        <motion.div variants={fadeUp} transition={smoothTransition}>
          {/* BADGE */}
          <div className="inline-flex items-center gap-2 rounded-full border border-[#d7e0e7] bg-white/10 px-3 py-1.5 text-xs font-semibold text-[#274c77] backdrop-blur-md dark:border-white/10 dark:bg-white/[0.03] dark:text-[#a3cef1]">
            <TrendingUp
              size={14}
          ...
          {/* TITLE */}
          <h2 className="mt-4 text-3xl font-black tracking-tight text-[#0f172a] dark:text-white md:text-4xl">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#d7e0e7] bg-white/[0.02] backdrop-blur-xl transition-all duration-300 group-hover:border-[#89c2d9]/40 group-hover:shadow-xl dark:border-white/5">
            <img
              ...
              alt="Reportes ERP"
              loading="lazy"
              className="h-[380px] w-full object-cover transition-transform duration-700 ease-out group-hover:scale-105"
            />
