// features/components/FeaturesHeroSection.jsx
...
const glowBase =
  "absolute -z-10 min-h-[75vh] w-80 rounded-full blur-3xl transform-gpu pointer-events-none";
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex w-fit items-center gap-2 rounded-full border border-[#274c77]/10 bg-white/80 px-3.5 py-1.5 text-xs font-semibold text-[#274c77] shadow-sm backdrop-blur-md dark:border-white/10 dark:bg-white/5 dark:text-[#dbeafe]"
            >
              <ShieldCheck size={14} />
            ...
            <motion.h1
              variants={fadeUp}
              transition={smoothTransition}
              className="mt-4 text-3xl font-black leading-tight tracking-tight text-[#0f172a] dark:text-white sm:text-4xl xl:text-5xl"
            >
            ...
            <motion.p
              variants={fadeUp}
              transition={smoothTransition}
              className="mt-4 max-w-xl text-sm leading-relaxed text-[#365d86] dark:text-[#cbd5e1] sm:text-base"
            >
            ...
            >
              {featureHighlights.map(({ icon: Icon, title, desc }) => (
                ...
                >
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-[#5b6472] dark:text-[#cbd5e1]">
                    {desc}
                  </p>
                </motion.div>
              ))}
