...
export default function BarcodeFeatures() {
  // Filtramos o seleccionamos los bloques enfocados en la automatización por código de barras
    ...
    <section className="relative overflow-hidden bg-dark text-dark-foreground px-4 py-24 sm:px-6 md:px-8 lg:px-10 z-10">
      ...
      <div className="mx-auto  w-full flex flex-col items-center">
        ...
        >
          ...
          >
            Operaciones a la velocidad de un{" "}
        ...
        {/* ================= REJILLA SIMÉTRICA DE 2 COLUMNAS (4 TARJETAS) ================= */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full  relative z-20">
          {barcodeFeatures.map((group, groupIdx) => (
            <motion.div
