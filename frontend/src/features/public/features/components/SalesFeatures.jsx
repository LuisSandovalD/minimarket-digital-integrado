...
import { SALES_FEATURES } from "../constants/featuresData.js";
    ...
    <section className="relative overflow-hidden bg-dark text-dark-foreground px-4 py-24 sm:px-6 md:px-8 lg:px-10 z-10">
      ...
      <div className="mx-auto  w-full flex flex-col items-center">
        ...
        >
          ...
          >
            Descubre las herramientas de última generación diseñadas para digitalizar, optimizar y automatizar cada
            flujo operativo de tu modelo comercial.
          </motion.p>
        </motion.div>

        {/* REJILLA IMPLEMENTANDO METRICCARD */}
        <div className="grid grid-cols-1 md:grid-cols-4  gap-8 w-full relative z-20">
          {SALES_FEATURES.map((group, groupIdx) => (
            <motion.div
            ...
            >
              ...
              >
                {/* Contenido inyectado dentro del MetricCard */}
