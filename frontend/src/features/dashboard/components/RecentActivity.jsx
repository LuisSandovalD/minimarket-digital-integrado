    ...
    <div className="rounded-3xl border border-slate-200/70 dark:border-slate-800/70 bg-white/70 dark:bg-slate-900/70 p-6 shadow-sm backdrop-blur-xl">
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard
          ...
          label="Usuarios"
          value={usersCount}
          subtext="Usuarios con actividad"
          variant="default"
        />
          ...
          <div className="space-y-3">
            {previewLogs.map((log) => {
              ...
              return (
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-100 dark:bg-slate-700">
