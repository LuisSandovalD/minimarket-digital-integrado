export default function UserAvatarSkeleton({
  ...
  return (
    <div className={`flex items-center justify-start text-left gap-2.5 animate-pulse ${className}`}>
      <div className="relative flex-shrink-0">
        <div className={`${currentSize.avatar} bg-slate-200 dark:bg-slate-700`} />
        {showStatus && (
          <div
      ...
      {showInfo && (
        <div className="min-w-0 flex-1 space-y-1.5">
          ...
          {showEmail && <div className="h-3 w-36 bg-slate-200/70 dark:bg-slate-700/70 rounded" />}
