// ========================================
// components/card/IconContainer.jsx
// ========================================
...
export default function IconContainer({
  ...
  const variants = {
    ...
    primary: "bg-[#274c77]/10 text-[#274c77] dark:bg-[#274c77]/20 dark:text-[#a3cef1]",
  ...
  return (
    <div
      className={clsx(
        ...
        variants[variant],
        radius[rounded],
        bordered && "border border-slate-100 dark:border-slate-800/60",
        shadow && "shadow-sm",
        className,
      )}
      {...props}
