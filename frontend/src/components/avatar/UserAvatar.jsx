...
export default function UserAvatar({
  ...
  const roleConfig = {
    ADMIN: { icon: ShieldCheck, label: 'Admin', color: 'text-violet-600 dark:text-violet-400' },
    MANAGER: { icon: UserCog, label: 'Manager', color: 'text-blue-600 dark:text-blue-400' },
    SUPERVISOR: { icon: Layers3, label: 'Supervisor', color: 'text-amber-600 dark:text-amber-400' },
    EMPLOYEE: { icon: User, label: 'Employee', color: 'text-emerald-600 dark:text-emerald-400' },
    VIEWER: { icon: Eye, label: 'Viewer', color: 'text-slate-600 dark:text-slate-400' },
  };
